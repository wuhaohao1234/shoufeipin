...
var TYPE_ARRAY = "[object Array]",
  ...
  updateDiff = function r(e, t, n, o) {
    ...
    if (_typeOf(a) !== TYPE_ARRAY || (_typeOf(i) !== TYPE_ARRAY || a.length === i.length) && _typeOf(i) === TYPE_ARRAY) return Object.entries(a).forEach(function (e) {
      var t = e[0],
        n = e[1],
        o = "" === s ? t : s + "." + t;
      _typeOf(a) === TYPE_ARRAY && (o = "" === s ? t : s + "[" + t + "]"), i.hasOwnProperty(t) ? _typeOf(i[t]) === TYPE_OBJECT && _typeOf(a[t]) === TYPE_OBJECT || _typeOf(i[t]) === TYPE_ARRAY && _typeOf(a[t]) === TYPE_ARRAY ? r(a[t], i[t], o, l) : i[t] !== a[t] && (l[o] = n) : l[o] = n
    }), l;
    l[s] = a
  },
  nullDiff = function o(e, t, n, r) {
    ...
    if (_typeOf(a) !== TYPE_ARRAY || (_typeOf(i) !== TYPE_ARRAY || a.length === i.length) && _typeOf(i) === TYPE_ARRAY) return Object.entries(i).forEach(function (e) {
      var t = e[0],
        n = "" === s ? t : s + "." + t;
      _typeOf(a) === TYPE_ARRAY && (n = "" === s ? t : s + "[" + t + "]"), a.hasOwnProperty(t) ? (_typeOf(i[t]) === TYPE_OBJECT && _typeOf(a[t]) === TYPE_OBJECT || _typeOf(i[t]) === TYPE_ARRAY && _typeOf(a[t]) === TYPE_ARRAY) && o(a[t], i[t], n, l) : l[n] = null
    }), l
  },
...
Object.keys || (Object.keys = function () {
  ...
  return function (e) {
    ...
    if (a)
      for (var o = 0; o < s; o++) r.call(e, i[o]) && t.push(i[o]);
    return t
  }
...
var Store = function () {
    function O(e) {
      ...
      function h(e, t) {
        ...
        e.$store = {};
        var o = n.useProp;
        n.hasOwnProperty("useProp") && (o && "string" == typeof o || _typeOf(o) === TYPE_ARRAY ? e.$store.useProp = [].concat(o) : e.$store.useProp = []), e.$store.useStore = v(n), v(n) && (d.$r.push(e), e.$store.useProp ? e.setData({
      ...
      if (App.Page = function () {
          ...
          v(o) && (o.data = _extends({}, o.data || {}, {
            $state: d.$state
          })), Object.keys(f).forEach(function (t) {
            "function" != typeof f[t] || g.some(function (e) {
              return e === t
            }) || (o[t] = f[t])
          });
          var r = o.onLoad;
          ...
          o.onUnload = function () {
            ...
            var n;
            "function" == typeof i[t] && g.some(function (e) {
              return e === t
            }) && (n = o[t], o[t] = function () {
              var e = i[t].apply(this, arguments);
              return n && n.apply(this, arguments) || e
            })
      ...
      if (App.Component = function () {
          ...
          _typeOf(o.lifetimes) === TYPE_OBJECT ? (o.lifetimes.attached = r, o.lifetimes.detached = a) : (o.attached = r, o.detached = a), m.apply(void 0, [o].concat(t))
        }, !l) try {
    ...
    return createClass(O, [{
      ...
      value: function (e, t) {
        ...
        var o, r, a, i, s = this.$state,
          l = setData(e, s);
        this.$state = l, 0 < this.$r.length ? (o = diff(l, s), this.debug && console.log("diff后实际设置的值：", _deepClone(o)), 0 < (r = Object.keys(o)).length ? (a = {}, r.forEach(function (e) {
          a["$state." + e] = o[e]
        ...
        }), Promise.all(i).then(n)) : n()) : n(), this.debug && console.timeEnd && console.timeEnd("setState")
      }
    }, {
      key: "getState",
      value: function () {
      ...
      value: function (e) {
        ...
        var n;
        this.$state = {}, 0 < this.$r.length ? (n = this.$r.map(function (t) {
          var n = {
            $state: {}
          };
          return new Promise(function (e) {
        ...
        }), Promise.all(n).then(t)) : t(), this.debug && console.timeEnd && console.timeEnd("clearState")
      }
    }]), O
  }(),
